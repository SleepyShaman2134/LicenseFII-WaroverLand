...
function scr_set_buttons(){
	if (sprite_index == spr_frenchhorn){
		button1 = instance_create_depth(1696, 1857, -2, obj_button);
		with(button1){
			buttontype=1;
		...
		button2 = instance_create_depth(1696, 1587, -2, obj_button);
		with(button2){
			buttontype=2;
			unit_sprite = player.player_units_sprite[other.cardNum];
			spacei = other.ipos;
		...
		button3 = instance_create_depth(1696, 1287, -2, obj_button);
		with(button3){
			buttontype=3;
			unit_sprite = player.player_units_sprite[other.cardNum];
			spacei = other.ipos;
