...
if(/*vari>2 &&*/ player.tier1.selected == true &&  game.gametier == 1 && isunit == 0){
	scr_set_unit(x, y);
	game.gametier = 0;
}

if(/*vari>2 &&*/ player.tier2.selected == true && game.gametier == 2 && isunit == 0){
	scr_set_unit(x, y);
	game.gametier = 0;
}

if(/*vari>2 &&*/ player.tier3.selected == true && game.gametier == 3 && isunit == 0){
	scr_set_unit(x, y);
	game.gametier = 0;
}
